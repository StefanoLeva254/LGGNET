...
if __name__ == '__main__':
    ...
    ######## Data ########
    parser.add_argument('--dataset', type=str, default='SEED') #DEAP
    parser.add_argument('--data-path', type=str, default='/home/dingyi/data/deap/')
    parser.add_argument('--subjects', type=int, default=15) #32
    parser.add_argument('--num-class', type=int, default=4, choices=[2, 3, 4])  #2
    parser.add_argument('--label-type', type=str, default='L', choices=['A', 'V', 'D', 'L'])
    parser.add_argument('--segment', type=int, default=4)
    parser.add_argument('--overlap', type=float, default=0)
    parser.add_argument('--sampling-rate', type=int, default=128) #128
    ...
    parser.add_argument('--max-epoch', type=int, default=28) #200
    parser.add_argument('--patient', type=int, default=20)
    parser.add_argument('--patient-cmb', type=int, default=8)
    parser.add_argument('--max-epoch-cmb', type=int, default=20) #20
